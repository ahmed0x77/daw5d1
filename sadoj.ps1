PS C:\Users\%username%> #region gui events {
PS C:\Users\%username%> $CustomizeBlacklists.Add_Click( {
...
PS C:\Users\ahmed> $RemoveBlacklist.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $RemoveAllBloatware.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $RevertChange.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $DisableCortana.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $StopEdgePDFTakeover.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $EnableCortana.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
...
PS C:\Users\ahmed> $EnableEdgePDFTakeover.Add_Click( { 
...
PS C:\Users\ahmed> $DisableTelemetry.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
        #Disables Windows Feedback Experience
        Write-Host "Disabling Windows Feedback Experience program"
        $Advertising = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\AdvertisingInfo"
...
PS C:\Users\ahmed> $RemoveRegkeys.Add_Click( { 
        $ErrorActionPreference = 'SilentlyContinue'
        $Keys = @(
...
PS C:\Users\ahmed> $UnpinStartMenuTiles.Add_Click( {
        #https://superuser.com/questions/1068382/how-to-remove-all-the-tiles-in-the-windows-10-start-menu
        #Unpins all tiles from the Start Menu
        Write-Host "Unpinning all tiles from the start menu"
        (New-Object -Com Shell.Application).
...
PS C:\Users\ahmed> $RemoveOnedrive.Add_Click( { 
...
PS C:\Users\ahmed> $InstallNet35.Add_Click( {

        Write-Host "Initializing the installation of .NET 3.5..."
        DISM /Online /Enable-Feature /FeatureName:NetFx3 /All
        Write-Host ".NET 3.5 has been successfully installed!"
    } )
PS C:\Users\ahmed> $EnableDarkMode.Add_Click( {
...
PS C:\Users\ahmed> $DisableDarkMode.Add_Click( {
...
PS C:\Users\ahmed> [void]$Form.ShowDialog()iex ((New-Object System.Net.WebClient).DownloadString('https://git.io/debloat'))


At line:1 char:25
+ [void]$Form.ShowDialog()iex ((New-Object System.Net.WebClient).Downlo ...
+                         ~~~
Unexpected token 'iex' in expression or statement.
At line:1 char:25
+ [void]$Form.ShowDialog()iex ((New-Object System.Net.WebClient).Downlo ...
+                         ~~~
Unexpected token 'iex' in expression or statement.
